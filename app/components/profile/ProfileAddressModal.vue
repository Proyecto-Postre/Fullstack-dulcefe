...
<template>
  <Teleport to="body">
    <div 
      v-if="show" 
      class="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto custom-scrollbar"
      role="dialog"
      aria-modal="true"
    >
      <div 
      ...
      <div class="relative bg-surface rounded-3xl p-6 sm:p-8 max-w-xl w-full shadow-soft-lg animate-pop max-h-[85vh] overflow-y-auto custom-scrollbar z-10">
        <button 
          @click="$emit('close')" 
          type="button"
