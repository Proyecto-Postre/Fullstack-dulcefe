  ...
  <div class="animate-pop">
    <div class="mb-8">
      <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 rounded-2xl bg-brand-cream border border-brand-primary/20 flex items-center justify-center text-brand-primary shadow-soft-sm">
          <Icon name="lucide:user" class="w-5 h-5" />
        </div>
        <div>
          <h2 class="text-2xl font-playfair font-bold text-brand-secondary">Datos Personales</h2>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div>
        ...
        <div class="relative">
          <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-brand-primary/50">
          ...
          <input 
            ...
            class="w-full pl-11 pr-4 py-3 bg-brand-cream/30 border border-brand-primary/20 rounded-2xl text-sm font-medium text-brand-secondary placeholder:text-brand-secondary/40 focus:outline-none focus:border-brand-primary focus:bg-surface focus:ring-2 focus:ring-brand-primary/10 transition-all"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <p class="text-[11px] text-brand-primary/70 mt-2 flex items-center gap-1.5 font-medium">
          <Icon name="lucide:info" class="w-3.5 h-3.5 shrink-0 text-brand-primary" />
          <span>El repartidor utilizará este número para contactarte y coordinar la entrega de tus postres.</span>
        </p>
      </div>
      ...
      <div>
        ...
        <div class="relative">
          <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-brand-primary/40">
          ...
          <input 
            ...
            type="email" 
            disabled
            class="w-full pl-11 pr-4 py-3 bg-brand-cream/60 border border-brand-primary/10 rounded-2xl text-sm font-medium text-brand-secondary/60 cursor-not-allowed select-none"
          />
        </div>
        <p class="text-[10px] text-brand-primary/60 mt-1.5">
          El correo electrónico está vinculado a tu cuenta y no puede cambiarse directamente.
        </p>
      </div>
      ...
      <div class="pt-4 border-t border-brand-primary/10 flex justify-end">
        <button 
          type="submit"
          :disabled="isSaving"
          class="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-brand-primary hover:bg-brand-secondary text-white font-bold text-xs shadow-soft-md hover:shadow-soft-lg transition-all cursor-pointer active:scale-98 disabled:opacity-50 disabled:cursor-not-allowed"
        >
